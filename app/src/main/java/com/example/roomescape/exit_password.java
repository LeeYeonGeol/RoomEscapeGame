...
public class exit_password extends Activity {
    TextView statusTxt;
    Button btn1;
    Button btn2;
    Button btn3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gv.editor.putBoolean("st1_cleared", false);
    ...
    public void st2_password(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.st2_password_input:
                ...
                if (st2_exit_password[0] == 6)
                    if (st2_exit_password[1] == 2)
                        if (st2_exit_password[2] == 1)
                            if (st2_exit_password[3] == 4) {
                                st2_answer = true;
                            }
                ...
                if(st2_answer == false){
                    ...
                    gv.editor.putBoolean("st1_cleared", true);
                    gv.editor.commit();
                    finish();
                }
                break;
